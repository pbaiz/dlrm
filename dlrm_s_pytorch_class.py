...
class DLRM_Model(object):
    ...
    parser.add_argument("--plot-compute-graph", action="store_true", default=True) # PBV default=False)
    # store/load model
    parser.add_argument("--save-model", type=str, default="default_saved_model")  # PBV default="")
    ...
    # export the model in onnx
    if args.save_model:
        torch.save(dlrm, args.save_model)
        #torch.save(dlrm.state_dict(), args.save_model)
